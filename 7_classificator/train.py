...
import pandas as pd
from labelling import filter_it, add_level_label
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to prepared raw CSV (from 5_parsing), with position/last_position columns.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
...
def main() -> None:
    ...
    plot_class_balance(
        ...
        title="Class balance: junior/middle/senior (IT developers)",
    )
    ...
    print(f"Saved class balance plot to: {args.output_dir / 'class_balance.png'}")
